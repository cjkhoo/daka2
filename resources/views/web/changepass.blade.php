...
<div class="containe  mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">{{ __('更改密碼') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.change.post') }}">
                        ...
                        <div class="form-group row">
                            <label for="current_password" class="col-md-4 col-form-label text-md-right">{{ __('目前密碼') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="new_password" class="col-md-4 col-form-label text-md-right">{{ __('新密碼') }}</label>
